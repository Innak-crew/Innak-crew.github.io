...
import { Card, CardHeader, CardBody, CardTitle, Table, Row, Col, Modal, ModalHeader, ModalBody, ModalFooter, Button, FormGroup,Form,Input } from "reactstrap";
...
function Tables() {
  ...
  const tableRows = questions?.data?.map((question, index) => (
  ...
  const pageSize = 1; // Number of items per page
    ...
    // Filter questions based on filter input
